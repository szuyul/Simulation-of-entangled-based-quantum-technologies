...
class observer():
    ...
    def eavesdropping_test(self, person, test_angle):
        ...
        if statistics.mean(exp_thy_diff_list) > 0.1: # ideally this should be Bell's inequality, |S| < 2
...
print('naive single photon scenario (observers using the same or perpendicular LP to photons to establish reliable key)')
